...
class PagoTipo extends \App\Entity\PagoTipo implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\PagoTipo' . "\0" . 'id', '' . "\0" . 'App\\Entity\\PagoTipo' . "\0" . 'nombre', '' . "\0" . 'App\\Entity\\PagoTipo' . "\0" . 'empresa', '' . "\0" . 'App\\Entity\\PagoTipo' . "\0" . 'orden', '' . "\0" . 'App\\Entity\\PagoTipo' . "\0" . 'estado'];
        }
