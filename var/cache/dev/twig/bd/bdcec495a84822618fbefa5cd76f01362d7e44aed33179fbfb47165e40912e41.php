...
/* agendadores/_form.html.twig */
class __TwigTemplate_d8db07ba94c3845971688e1de944959f294a72f6e94707e7f7ef9dc5e83c1181 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "agendadores/_form.html.twig"));

        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02 = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "agendadores/_form.html.twig"));
...
\t\t\t\t\t<select name=\"cboUsuarioCategoria\" class=\"form-control\" required>
\t\t\t\t\t\t<option></option>
\t\t\t\t\t\t";
        // line 65
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["usuarioCategorias"]) || array_key_exists("usuarioCategorias", $context) ? $context["usuarioCategorias"] : (function () { throw new RuntimeError('Variable "usuarioCategorias" does not exist.', 65, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["usuarioCategoria"]) {
            // line 66
            echo "\t\t\t\t\t\t\t<option value=\"";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["usuarioCategoria"], "id", [], "any", false, false, false, 66), "html", null, true);
            echo "\"
\t\t\t\t\t\t\t";
            // line 67
            if (array_key_exists("usuario", $context)) {
                // line 68
                echo "\t\t\t\t\t\t\t\t";
                if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["usuario"]) || array_key_exists("usuario", $context) ? $context["usuario"] : (function () { throw new RuntimeError('Variable "usuario" does not exist.', 68, $this->source); })()), "categoria", [], "any", false, false, false, 68), "id", [], "any", false, false, false, 68), twig_get_attribute($this->env, $this->source, $context["usuarioCategoria"], "id", [], "any", false, false, false, 68)))) {
                    // line 69
                    echo "\t\t\t\t\t\t\t\t\tselected
\t\t\t\t\t\t\t\t";
                }
            ...
            // line 72
            echo "\t\t\t\t\t\t\t>";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["usuarioCategoria"], "nombre", [], "any", false, false, false, 72), "html", null, true);
            echo "</option>
\t\t\t\t\t\t";
        }
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['usuarioCategoria'], $context['_parent'], $context['loop']);
        $context = array_intersect_key($context, $_parent) + $_parent;
        // line 73
        echo "}
\t\t\t\t\t</select>
...
\t\t\t\t</div>
\t\t\t\t<div class=\"col-sm-6 col-md-3\">
\t\t\t\t\t<small class=\"text-muted\">Status Lead</small>
\t\t\t\t\t<select name=\"cboStatues\" class=\"form-control\" required>
\t\t\t\t\t\t<option></option>
\t\t\t\t\t\t";
        // line 81
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["statues"]) || array_key_exists("statues", $context) ? $context["statues"] : (function () { throw new RuntimeError('Variable "statues" does not exist.', 81, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["status"]) {
            // line 82
            echo "\t\t\t\t\t\t\t<option value=\"";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["status"], "id", [], "any", false, false, false, 82), "html", null, true);
            echo "\"
\t\t\t\t\t\t\t";
            // line 83
            if (array_key_exists("usuario", $context)) {
                // line 84
                echo "\t\t\t\t\t\t\t\t";
                if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["usuario"]) || array_key_exists("usuario", $context) ? $context["usuario"] : (function () { throw new RuntimeError('Variable "usuario" does not exist.', 84, $this->source); })()), "status", [], "any", false, false, false, 84), "id", [], "any", false, false, false, 84), twig_get_attribute($this->env, $this->source, $context["status"], "id", [], "any", false, false, false, 84)))) {
                    // line 85
                    echo "\t\t\t\t\t\t\t\t\tselected
\t\t\t\t\t\t\t\t";
                }
            ...
            // line 88
            echo "\t\t\t\t\t\t\t>";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["status"], "nombre", [], "any", false, false, false, 88), "html", null, true);
            echo "</option>
\t\t\t\t\t\t";
        }
        $_parent = $context['_parent'];
...
\t\t\t\t\t\t";
        // line 99
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["tipo_documentos"]) || array_key_exists("tipo_documentos", $context) ? $context["tipo_documentos"] : (function () { throw new RuntimeError('Variable "tipo_documentos" does not exist.', 99, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["tipo_documento"]) {
            // line 100
            echo "\t\t\t\t\t\t\t<option value=\"";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["tipo_documento"], "id", [], "any", false, false, false, 100), "html", null, true);
            echo "\"
\t\t\t\t\t\t\t";
            // line 101
            if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["usuario"] ?? null), "tipoDocumento", [], "any", false, true, false, 101), "id", [], "any", true, true, false, 101)) {
                // line 102
                echo "
\t\t\t\t\t\t\t\t\t";
                // line 103
                if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["usuario"]) || array_key_exists("usuario", $context) ? $context["usuario"] : (function () { throw new RuntimeError('Variable "usuario" does not exist.', 103, $this->source); })()), "tipoDocumento", [], "any", false, false, false, 103), "id", [], "any", false, false, false, 103), twig_get_attribute($this->env, $this->source, $context["tipo_documento"], "id", [], "any", false, false, false, 103)))) {
                    // line 104
                    echo "\t\t\t\t\t\t\t\t\t\tselected
\t\t\t\t\t\t\t\t\t";
                }
...
\t\t\t\t\t\t\t";
            ...
            // line 108
            echo "\t\t\t\t\t\t\t>";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["tipo_documento"], "nombre", [], "any", false, false, false, 108), "html", null, true);
            echo "</option>
\t\t\t\t\t\t";
        }
        $_parent = $context['_parent'];
...
\t\t\t\t\t";
        // line 121
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 121, $this->source); })()), "username", [], "any", false, false, false, 121), 'row', ["label" => false, "attr" => ["class" => "form-control", "placeholder" => "Usuario"]]);
        echo "
\t\t\t\t</div>
\t\t\t\t<div class=\"col-sm-6 col-md-3\">
...
\t\t\t\t\t";
        // line 125
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 125, $this->source); })()), "password", [], "any", false, false, false, 125), 'row', ["label" => false, "attr" => ["class" => "form-control", "placeholder" => "******", "type" => "password", "required" => false]]);
        echo "
\t\t\t\t\t";
        // line 126
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 126, $this->source); })()), "passwordAnt", [], "any", false, false, false, 126), 'row', ["label" => false, "attr" => ["class" => "form-control", "placeholder" => "******", "type" => "password", "required" => false]]);
        echo "
\t\t\t\t</div>
\t\t\t</div>
\t\t</section>
...
\t\t<button class=\"btn btn-primary\">";
        // line 132
        echo twig_escape_filter($this->env, ((array_key_exists("button_label", $context)) ? (_twig_default_filter((isset($context["button_label"]) || array_key_exists("button_label", $context) ? $context["button_label"] : (function () { throw new RuntimeError('Variable "button_label" does not exist.', 132, $this->source); })()), "Crear")) : ("Crear")), "html", null, true);
        echo "</button>
\t</div>
</div>
...
";
    ...
    {
        return "agendadores/_form.html.twig";
    }
    ...
    {
        return array (  331 => 144,  316 => 132,  307 => 126,  303 => 125,  296 => 121,  282 => 109,  273 => 108,  269 => 106,  265 => 104,  263 => 103,  260 => 102,  258 => 101,  253 => 100,  249 => 99,  237 => 89,  228 => 88,  225 => 87,  221 => 85,  218 => 84,  216 => 83,  211 => 82,  207 => 81,  197 => 73,  188 => 72,  185 => 71,  181 => 69,  178 => 68,  176 => 67,  171 => 66,  167 => 65,  157 => 58,  149 => 53,  141 => 48,  133 => 43,  126 => 39,  118 => 34,  110 => 29,  103 => 24,  94 => 23,  91 => 22,  85 => 21,  81 => 19,  78 => 18,  73 => 17,  71 => 16,  66 => 15,  62 => 14,  55 => 10,  43 => 1,);
    }
...
\t\t\t\t\t<select name=\"cboUsuarioCategoria\" class=\"form-control\" required>
\t\t\t\t\t\t<option></option>
\t\t\t\t\t\t{% for usuarioCategoria in usuarioCategorias %}
\t\t\t\t\t\t\t<option value=\"{{usuarioCategoria.id}}\"
\t\t\t\t\t\t\t{% if usuario is defined %}
\t\t\t\t\t\t\t\t{% if usuario.categoria.id == usuarioCategoria.id%}
\t\t\t\t\t\t\t\t\tselected
\t\t\t\t\t\t\t\t{% endif %}
\t\t\t\t\t\t\t{% endif %}
\t\t\t\t\t\t\t>{{usuarioCategoria.nombre}}</option>
\t\t\t\t\t\t{% endfor %}}
\t\t\t\t\t</select>
\t\t\t\t\t
\t\t\t\t</div>
...
\t</script>
{{ form_end(form) }}
", "agendadores/_form.html.twig", "D:\\htdocs\\desarrollos_symfony\\micrm\\crm v.2\\templates\\agendadores\\_form.html.twig");
    }
}
