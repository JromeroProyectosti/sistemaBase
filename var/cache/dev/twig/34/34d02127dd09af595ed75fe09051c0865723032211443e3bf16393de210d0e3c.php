...
class __TwigTemplate_f0ee7bf724930253f0b8fb4680126b0f71cbce9710c05e95133cf46fb90c16be extends Template
{
    private $source;
    private $macros = [];
...
{% block body %}
    ...
    <div class=\"alert alert-danger alert-dismissible\">
        <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">&times;</button>
        <h5><i class=\"icon fas fa-ban\"></i> Error!</h5>
        A ocurrido un error inesperado, solicita informacion a tu administrador <a href=\"{{ path('dashboard') }}\">Retorna home</a>.
    </div>
{% endblock %}", "@Twig/Exception/error.html.twig", "D:\\htdocs\\desarrollos_symfony\\micrm\\crm v.2\\templates\\bundles\\TwigBundle\\Exception\\error.html.twig");
    }
}
