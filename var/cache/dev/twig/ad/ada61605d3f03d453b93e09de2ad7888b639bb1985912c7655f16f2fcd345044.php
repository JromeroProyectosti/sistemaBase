...
/* administrativo/index.html.twig */
class __TwigTemplate_bc38121fcf3823b04bcafd92ea0fbb93a51763a737d3c06a4fc698c15f47adbe extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "administrativo/index.html.twig"));

        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02 = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "administrativo/index.html.twig"));

        $this->parent = $this->loadTemplate("base.html.twig", "administrativo/index.html.twig", 1);
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        if ((0 === twig_compare((isset($context["modo"]) || array_key_exists("modo", $context) ? $context["modo"] : (function () { throw new RuntimeError('Variable "modo" does not exist.', 12, $this->source); })()), 1))) {
            // line 13
            echo "            <a href=\"";
            echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("administrativo_new");
            echo "\" class=\"btn btn-primary\" id=\"btn-agregar\"><i class=\"fas fa-plus\"></i></a>
            <a href=\"";
            // line 14
            echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("administrativo_index", ["modo" => "trash"]);
            echo "\" class=\"btn btn-danger\"><i class=\"fas fa-trash\"></i> Usuarios Eliminados</a>
        ";
        } else {
            // line 16
            echo "            <a href=\"";
            echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("administrativo_index");
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["usuario"]) {
            ...
            if ((0 === twig_compare((isset($context["modo"]) || array_key_exists("modo", $context) ? $context["modo"] : (function () { throw new RuntimeError('Variable "modo" does not exist.', 43, $this->source); })()), 1))) {
                // line 44
                echo "                                <a href=\"";
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("administrativo_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["usuario"], "id", [], "any", false, false, false, 44)]), "html", null, true);
                echo "\" class=\"btn btn-secondary\"><spam class='fas fa-edit'></spam></a>
                                ";
                // line 45
                echo twig_include($this->env, $context, "administrativo/_delete_form.html.twig", ["id_usuario" => twig_get_attribute($this->env, $this->source, $context["usuario"], "id", [], "any", false, false, false, 45)]);
                echo "
                                <a href=\"";
                // line 46
                ...
                // line 48
                echo "                                <a href=\"";
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("administrativo_restore", ["id" => twig_get_attribute($this->env, $this->source, $context["usuario"], "id", [], "any", false, false, false, 48)]), "html", null, true);
...
";
    ...
    {
        return "administrativo/index.html.twig";
    }
    ...
    {
        return array (  225 => 58,  216 => 54,  200 => 50,  194 => 48,  189 => 46,  185 => 45,  180 => 44,  178 => 43,  171 => 39,  167 => 38,  163 => 37,  159 => 36,  155 => 35,  151 => 34,  147 => 32,  129 => 31,  114 => 18,  108 => 16,  103 => 14,  98 => 13,  96 => 12,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<div class=\"card\">
        ...
        {% if modo == 1 %}
            <a href=\"{{path('administrativo_new')}}\" class=\"btn btn-primary\" id=\"btn-agregar\"><i class=\"fas fa-plus\"></i></a>
            <a href=\"{{path('administrativo_index',{'modo':'trash'})}}\" class=\"btn btn-danger\"><i class=\"fas fa-trash\"></i> Usuarios Eliminados</a>
        {% else %}
            <a href=\"{{path('administrativo_index')}}\" class=\"btn btn-success\"><i class=\"fas fa-trash-restore\"></i> Usuarios Activos</a>
        {% endif %}
            <table class=\"table\">
                <thead>
                    <tr>
                ...
                {% for usuario in usuarios %}
                    <tr>
                        ...
                        <td>
                            <div class=\"btn-group btn-group-sm\" role=\"group\" aria-label=\"Basic example\">
                                {% if modo == 1 %}
                                <a href=\"{{path('administrativo_edit',{'id':usuario.id})}}\" class=\"btn btn-secondary\"><spam class='fas fa-edit'></spam></a>
                                {{ include('administrativo/_delete_form.html.twig',{'id_usuario':usuario.id}) }}
                                <a href=\"{{path('privilegio_index',{'id':usuario.id})}}\" class=\"btn btn-warning\" > <i class=\"fas fa-share-alt\"></i></a>
                                {% else %}
                                <a href=\"{{path('administrativo_restore',{'id':usuario.id})}}\" class=\"btn btn-success\"><spam class='fas fa-trash-restore'></spam></a>
                                {% endif %}
                            </div>
                        </td>
                    </tr>
...
{% endblock %}
", "administrativo/index.html.twig", "D:\\htdocs\\desarrollos_symfony\\micrm\\crm v.2\\templates\\administrativo\\index.html.twig");
    }
}
