...
class __TwigTemplate_7e1b1fc699540db190b37724317e4f4a7040dd180236ca0e985b687669eac934 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        if ((0 === twig_compare((isset($context["modo"]) || array_key_exists("modo", $context) ? $context["modo"] : (function () { throw new RuntimeError('Variable "modo" does not exist.', 12, $this->source); })()), 1))) {
            ...
            <a href=\"";
            // line 14
            echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("clientes_index", ["modo" => "trash"]);
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["usuario"]) {
            ...
            if ((0 === twig_compare((isset($context["modo"]) || array_key_exists("modo", $context) ? $context["modo"] : (function () { throw new RuntimeError('Variable "modo" does not exist.', 43, $this->source); })()), 1))) {
                // line 44
                echo "                                <a href=\"";
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("clientes_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["usuario"], "id", [], "any", false, false, false, 44)]), "html", null, true);
                echo "\" class=\"btn btn-secondary\"><spam class='fas fa-edit'></spam></a>
                                ";
                // line 45
                echo twig_include($this->env, $context, "clientes/_delete_form.html.twig", ["id_usuario" => twig_get_attribute($this->env, $this->source, $context["usuario"], "id", [], "any", false, false, false, 45)]);
                echo "
                                <a href=\"";
                // line 46
                ...
                // line 48
                echo "                                <a href=\"";
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("clientes_restore", ["id" => twig_get_attribute($this->env, $this->source, $context["usuario"], "id", [], "any", false, false, false, 48)]), "html", null, true);
...
<div class=\"card\">
        ...
        {% if modo == 1 %}
        <a href=\"{{path('clientes_new')}}\" class=\"btn btn-primary\" id=\"btn-agregar\"><i class=\"fas fa-plus\"></i></a>
            <a href=\"{{path('clientes_index',{'modo':'trash'})}}\" class=\"btn btn-danger\"><i class=\"fas fa-trash\"></i> Usuarios Eliminados</a>
        {% else %}
            <a href=\"{{path('clientes_index')}}\" class=\"btn btn-success\"><i class=\"fas fa-trash-restore\"></i> Usuarios Activos</a>
        {% endif %}
            <table class=\"table\">
                <thead>
                    <tr>
                ...
                {% for usuario in usuarios %}
                    <tr>
                        ...
                        <td>
                            <div class=\"btn-group btn-group-sm\" role=\"group\" aria-label=\"Basic example\">
                                {% if modo == 1 %}
                                <a href=\"{{path('clientes_edit',{'id':usuario.id})}}\" class=\"btn btn-secondary\"><spam class='fas fa-edit'></spam></a>
                                {{ include('clientes/_delete_form.html.twig',{'id_usuario':usuario.id}) }}
                                <a href=\"{{path('privilegio_index',{'id':usuario.id})}}\" class=\"btn btn-warning\" > <i class=\"fas fa-share-alt\"></i></a>
                                {% else %}
                                <a href=\"{{path('clientes_restore',{'id':usuario.id})}}\" class=\"btn btn-success\"><spam class='fas fa-trash-restore'></spam></a>
...
{% endblock %}
", "clientes/index.html.twig", "D:\\htdocs\\desarrollos_symfony\\micrm\\crm v.2\\templates\\clientes\\index.html.twig");
    }
}
