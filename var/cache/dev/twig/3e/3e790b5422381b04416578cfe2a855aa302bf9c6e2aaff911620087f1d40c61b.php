...
/* menu/edit.html.twig */
class __TwigTemplate_c456684a1cbe7b9920ec429479b62a48d5fb975435251bda5e90f9d47face5ea extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        ";
        // line 12
        echo twig_include($this->env, $context, "menu/_form.html.twig", ["button_label" => "Modificar"]);
        echo "
...
";
    ...
    {
        return array (  105 => 15,  99 => 12,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
   <div class=\"card\">
        <div class=\"card-header\">
        Editar item para Men&uacute; {{menuCabezera.nombre}}
        </div>

        <div class=\"card-body\">
        {{ include('menu/_form.html.twig', {'button_label': 'Modificar'}) }}

    
                   <div class=\"col-2\"> {{ include('menu/_delete_form.html.twig') }}</div>
                   </div>
        </div>
    </div>
...
{% endblock %}
", "menu/edit.html.twig", "D:\\htdocs\\desarrollos_symfony\\micrm\\crm v.2\\templates\\menu\\edit.html.twig");
    }
}
