...
class __TwigTemplate_3b0c43e42aee62d5a46f77611556d011614f8b4e5f43e36d3e6802d71486e517 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"alert alert-danger alert-dismissible\">
        ...
        No tienes suficientes privilegios para acceder a este modulo, solicita informacion a tu administrador <a href=\"";
        // line 9
...
";
    ...
    {
        return new Source("{# templates/bundles/TwigBundle/Exception/error403.html.twig #}
...
{% block body %}
    ...
    <div class=\"alert alert-danger alert-dismissible\">
        <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">&times;</button>
        <h5><i class=\"icon fas fa-ban\"></i> Error!</h5>
        No tienes suficientes privilegios para acceder a este modulo, solicita informacion a tu administrador <a href=\"{{ path('dashboard') }}\">Retorna home</a>.
    </div>
{% endblock %}", "@Twig/Exception/error403.html.twig", "D:\\htdocs\\desarrollos_symfony\\micrm\\crm v.2\\templates\\bundles\\TwigBundle\\Exception\\error403.html.twig");
    }
}
